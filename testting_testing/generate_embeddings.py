...
def generate_risk_heatmap(json_data, output_prefix): # unchanged
...
def generate_case_studies(json_data, output_prefix): # unchanged
...
def simulate_fund_metrics(text):
    """Simulate ROI, tokenomics, and fund lifecycle."""
...
def generate_embeddings(chunk_data, output_prefix, full_text=None):
    ...
    if refined_json_data:
        ...
        # Add document-level embedding to metadata
